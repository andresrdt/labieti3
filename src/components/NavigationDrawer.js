            ...
            <div>
                ...
                <Drawer open={this.state.open} variant="persistent" anchor="left">
                    ...
                    <div className={classes.list}>
                        <List>
                            <ListItem>
                                <PersonOutlineSharpIcon alt="user" className="img2"/>
                                <ListItemText primary="Andres" secondary="andres@gmail.com" />
                            </ListItem>
                        </List>
                        <div className="right">
                            < BuildSharpIcon alt="edit"/>
                        </div>
                    </div>
                    <Divider/>
                    <div className="bottom">
                        <ExitToAppSharpIcon alt="logout"/>
